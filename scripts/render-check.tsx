...
assert(html.includes('e.g. Gogo CTO'), 'company name shows an example placeholder')
assert(html.includes('Insert a template'), 'line-item template picker present')
assert(html.includes('Country (optional)'), 'country picker present')
